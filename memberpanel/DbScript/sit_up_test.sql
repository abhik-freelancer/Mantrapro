...
/*Table structure for table `sit_up_test` */

DROP TABLE IF EXISTS `sit_up_test`;

CREATE TABLE `sit_up_test` (
  ...
  PRIMARY KEY (`tran_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2850 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
