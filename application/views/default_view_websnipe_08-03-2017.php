...
<head>
    ...
    <!-- Custom css -->
    <link rel="stylesheet" href="<?php echo base_url();?>application/assets/css/styleNewCSS.css" />
    <!-- Bootstrap Core CSS -->
	...
	<header id="header-top">
		 <input type="hidden" value="<?php echo base_url(); ?>" id="basepath"></input> 
			...
			<div class="header-top-left">
				<div class="mantra-cache-line">
					<span class="inspired">Inspired</span>
					<span class="by">by</span>
					<p class="fitness">FITNESS</p>
				</div>
			</div>
			<div class="header-top-right">
				<div class="mantra-logo-container">
					<div class="log-container-left">
						<img src="<?php echo base_url();?>application/assets/images/mantra-logo.png" class="mantra-logo" />
					</div>
					<div class="log-container-right">
						
						<span class="mantra-title">MANTRA <span class="registered">&reg;</span></span>
						<p class="mantra-title-catch-line">LIFE STYLE HEALTH CLUB</p>
					</div>
				</div>
			</div>
